...
export default function ContactForm() {
    ...
    return (
        <div className="isolate bg-gradient-to-br from-gray-900 to-black border border-purple-900/30 px-6 py-24 sm:py-32 lg:px-8 shadow-lg shadow-purple-500/20">
            <div
                aria-hidden="true"
            ...
            <div className="mx-auto max-w-2xl text-center">
                <h2 className="text-4xl font-semibold tracking-tight text-balance text-text sm:text-5xl">Contact me</h2>
           
            </div>
            <form action="https://formspree.io/f/mdkglewl" target='_blank' method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
                <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                    ...
                    <div className="sm:col-span-2">
                        <label htmlFor="company" className="block text-sm/6 font-semibold text-gray-300">
                            Company
                        </label>
                        <div className="mt-2.5">
                            <input
                ...
                <div className="mt-10">
                    <button
                        type="submit"
                        className="block w-full rounded-md bg-primary px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-xs hover:bg-primary/50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                    >
                        Send Email
                    </button>
                </div>
